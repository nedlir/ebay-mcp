/**
 * Query parameters for listing return policies.
 */
export type GetReturnPoliciesQuery = {
  /**
   * ID of the eBay marketplace whose policies to retrieve (e.g., "EBAY_US").
   * Occurrence: Required
   */
...
/**
 * Paged response of return policies.
 */
export type ReturnPolicyResponse = {
  ...
  /**
   * Policies defined for the specified marketplace.
   * Empty if none.
   * Occurrence: Always
   */
  ...
  /**
   * Total number of policies in the result.
   * Occurrence: Always
   */
  total: number;
};
 ...
 * @description Retrieves all return policies configured for a specified marketplace, using the marketplace_id query parameter.
 * @method GET
 ...
 */
export type GetReturnPoliciesAPI = {
  method: "GET";
  path: "/sell/account/v1/return_policy";
  query: GetReturnPoliciesQuery;
