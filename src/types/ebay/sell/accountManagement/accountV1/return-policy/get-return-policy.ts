/**
 * Path parameter for get operation.
 */
export type GetReturnPolicyParams = {
  /**
   * Unique identifier of the return policy to retrieve.
   * Occurrence: Required
   */
 ...
 * @description Retrieves the complete details of a return policy specified by returnPolicyId in the path.
 * @method GET
 ...
 */
export type GetReturnPolicyAPI = {
  method: "GET";
  path: "/sell/account/v1/return_policy/{return_policy_id}";
  params: GetReturnPolicyParams;
