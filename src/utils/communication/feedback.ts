...
export const leaveFeedbackForBuyerSchema = z.object({
  ...
  }).max(500, "comment_text must be 500 characters or less").optional(),
  ...
  seller_ratings: z.array(z.object({
    key: z.string({
...
export const respondToFeedbackSchema = z.object({
  ...
  }).max(500, "response_text must be 500 characters or less").optional(),
