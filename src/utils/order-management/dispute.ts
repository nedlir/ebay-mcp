...
type GetPaymentDisputeSummariesParams = operations["getPaymentDisputeSummaries"]["parameters"]["query"];
...
export const getPaymentDisputeSummariesSchema = z.object({
  ...
  payment_dispute_status: z.string({
...
export const contestPaymentDisputeSchema = z.object({
  ...
  }).max(1000, "Note must not exceed 1000 characters").optional(),
